...
def add_student():
    ...
    df_students = pd.read_excel('hogwarts.xlsx', sheet_name='Students', index_col=0)    
    df = df_students.append(student_data, ignore_index=True)
    
    df.index = np.arange(1, len(df) + 1)
    df.to_excel('hogwarts.xlsx', sheet_name="Students")
...
def change_student_data():
    ...
    df_students.to_excel('hogwarts.xlsx', sheet_name="Students")
